    ...
    <div className={`relative flex items-center ${className}`}>
      ...
      {speedLines && (
        <div className="absolute right-[85%] top-1/2 -translate-y-1/2 w-32 sm:w-60 h-20 flex flex-col justify-between opacity-70 pointer-events-none">
          <div className="h-[2px] w-full bg-gradient-to-l from-rose-500/80 to-transparent animate-pulse" />
          <div className="h-[1.5px] w-[80%] bg-gradient-to-l from-cyan-400/60 to-transparent self-end" />
          <div className="h-[2px] w-[90%] bg-gradient-to-l from-rose-500/60 to-transparent" />
          <div className="h-[1px] w-[60%] bg-gradient-to-l from-cyan-400/40 to-transparent self-end" />
        </div>
      )}

      {/* Exhaust Smoke / Particle Glow */}
      <div className="absolute -left-6 top-[60%] w-12 h-6 bg-gradient-to-l from-rose-500/50 via-rose-600/20 to-transparent rounded-full blur-sm animate-ping pointer-events-none opacity-60" />

      {/* Stylized Vector Cyber Racing Supercar */}
      <svg
        className="w-64 sm:w-96 md:w-[460px] h-auto drop-shadow-[0_10px_25px_rgba(230,57,70,0.3)] filter"
        viewBox="0 0 500 160"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <defs>
          {/* Main Car Body Metallic Gradient */}
          <linearGradient id="carBody" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#1a1e29" />
            <stop offset="40%" stopColor="#0f131d" />
        ...
        <ellipse cx="250" cy="148" rx="210" ry="10" fill="#000000" opacity="0.8" />

        {/* Rear Spoiler Wings */}
        <path d="M 40 60 L 90 60 L 80 40 L 25 40 Z" fill="#0a0c10" stroke="#e63946" strokeWidth="1.5" />
        ...
        <path d="M 180 88 L 310 84 L 320 89 L 190 93 Z" fill="#e63946" />

        {/* CodeChef VITC Racing Emblem / Lettering on Side */}
        <rect x="220" y="93" width="70" height="10" rx="2" fill="#090d16" opacity="0.9" />
        <text x="224" y="101" fill="#ffffff" fontSize="7" fontFamily="monospace" fontWeight="bold" letterSpacing="0.5">
          VITC CC
        </text>

        {/* Front Splitter / Air Intake */}
        <path d="M 450 120 L 495 120 L 485 132 L 440 130 Z" fill="#090d16" stroke="#00f5d4" strokeWidth="1" />

        {/* Front Headlights Assembly (Laser Cyan & Crimson Accent) */}
        ...
        <g className="animate-spin origin-[110px_125px]" style={{ animationDuration: '0.4s' }}>
          <circle cx="110" cy="125" r="28" fill="#0a0c10" stroke="#e63946" strokeWidth="3" />
          <circle cx="110" cy="125" r="18" fill="#1f293d" stroke="#00f5d4" strokeWidth="1.5" />
          <line x1="110" y1="97" x2="110" y2="153" stroke="#e63946" strokeWidth="2" />
          <line x1="82" y1="125" x2="138" y2="125" stroke="#e63946" strokeWidth="2" />
          <circle cx="110" cy="125" r="6" fill="#ffffff" />
        </g>

        {/* Front Wheel */}
        <g className="animate-spin origin-[400px_125px]" style={{ animationDuration: '0.4s' }}>
          <circle cx="400" cy="125" r="26" fill="#0a0c10" stroke="#e63946" strokeWidth="3" />
          <circle cx="400" cy="125" r="16" fill="#1f293d" stroke="#00f5d4" strokeWidth="1.5" />
          <line x1="400" y1="99" x2="400" y2="151" stroke="#e63946" strokeWidth="2" />
          <line x1="374" y1="125" x2="426" y2="125" stroke="#e63946" strokeWidth="2" />
